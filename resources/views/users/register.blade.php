  ...
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/users">
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded-full p-2 w-full" name="name" value="{{old('name')}}" />
      ...
      <div class="mb-6">
        ...
        <input type="password" class="border border-gray-200 rounded-full p-2 w-full" name="password_confirmation"
      ...
      <div class="mt-8">
        <p>
          ...
          <a href="/login" class="text-red-700">Login</a>
        </p>
      </div>
    </form>
  </x-card>
